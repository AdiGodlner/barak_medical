...
export const militaryMedicine: Card = {
  imageUrl: '/assets/images/cards/refuha zaba.svg',
  title: 'רפואה צבאית',
...
export const divingMedicine: Card = {
  imageUrl: '/assets/images/cards/refuha zlila.svg',
  title: 'רפואת צלילה',
...
export const aviationMedicine: Card = {
  imageUrl: '/assets/images/cards/refua teufa.svg',
  title: 'רפואה תעופתית',
...
export const workAbility: Card = {
  imageUrl: '/assets/images/cards/kusher havoda.svg',
  title: 'כושר עבודה',
...
export const causalLinkAssessment: Card = {
  imageUrl: '/assets/images/cards/kviat kesher sibati.svg',
  title: 'קשר סיבתי',
...
export const medicalRights: Card = {
  imageUrl: '/assets/images/cards/mitzoi zhuout refuieot.svg',
  title: 'מיצוי זכויות',
